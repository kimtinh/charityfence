...
@section('content')
    <main class="main explore">
        <section class="my-2 pb-4 container">
            ...
            <div class="mt-2 mb-4">
                <form method="GET" action="{{route('view.articles')}}" accept-charset="UTF-8" id="search-form">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="input-group">
                                    <input id="name" class="form-control" placeholder="Nhập từ khóa" name="search" type="text"
                    ...
                    <article class="card campaign-style2 mb-4">
                        <div class="embed-responsive embed-responsive-16by9">
                            <a href="{{route('view.articles.detail', $item->id)}}">
                                ...
                                src="{{asset($item->image ?? 'images/no-img.jpg')}}">
                            </a>
                        </div>
