...
@section('content')
    <main class="main createCampaign">
        <section class="my-2 container">
            <h1 class="mb-4">Sửa chiến dịch</h1>
            <form method="POST" action="{{route('view.campaign.update', $campaign->id)}}" accept-charset="UTF-8" id="campaign-form"
                    ...
                    <div class="col-md-8 order-2 order-md-1">
                        <div class="embed-responsive embed-responsive-16by9 image-file-com">
                            ...
                            <div class="embed-responsive-item d-flex justify-content-center align-items-center text-center">
                                ...
                                </label> <input accept="image/*" hidden="" value="" id="campaign-cover" name="images" type="file">
                            </div>
                        </div>
                        <div class="form-group mt-3 mb-5">
                            <label for="campaign-embed">Mã nhúng video (không bắt buộc)</label> <textarea
                                ...
                                rows="3" maxlength="1000" name="video" cols="50">{{$campaign->video}}</textarea>
                        ...
                        <div class="form-group mt-4">
                            ...
                            <textarea name="content" id="editor1" required>{!! $campaign->content !!}</textarea>
                    ...
                    <div class="col-md-4 order-1 order-md-2">
                        <div class="form-group">
                            <label for="campaign-name">Tên chiến dịch*</label> <input id="campaign-name" required=""
                                class="form-control" placeholder="Tên chiến dịch" value="{{$campaign->name}}" maxlength="255" name="name" type="text">
                        </div>
                        <div class="form-group">
                            <label for="campaign-description">Mô tả ngắn*</label> <textarea id="campaign-description"
                                ...
                                name="description" cols="50">{{$campaign->description}}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input id="campaign-money" required="" class="form-control" placeholder="Số tiền mong muốn"
                                    maxlength="15" value="{{$campaign->amount}}" name="amount" type="number">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group single-date">
                                <input id="campaign-deadline" required=""
                                    placeholder="Ngày hết hạn"  class="form-control" maxlength="255" value="{{$campaign->date_end}}" name="date_end" type="date">
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <script>
        $(function() {
            ...
            @if($campaign && $campaign->images)
                $('.image-file-com').css({'background' : "url({{asset($campaign->images)}}) no-repeat center center", 'background-size':'cover'});
            @endif
